              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>{{$maintenance->late_fine_type}} {{$maintenance->late_fine_value}}</td>
                    <td>{{ optional($maintenance->payments)->sum('paid_amount') ?? 0 }}</td>
                    <td>{{ optional($maintenance->payments)->sum('dues_amount') ?? 0 }}</td>
                    <td>{{ optional($maintenance->payments)->sum('late_fine') ?? 0 }}</td>
                    <td>{{  optional($maintenance->payments)->sum('paid_amount') ?? 0 + optional($maintenance->payments)->sum('dues_amount') ?? 0 + optional($maintenance->payments)->sum('late_fine') ?? 0}}</td>
