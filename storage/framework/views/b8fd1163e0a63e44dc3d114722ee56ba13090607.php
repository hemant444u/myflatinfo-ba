          ...
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                ...
                ?>
                <span><?php echo e($created_counts); ?>/<?php echo e($login_limit); ?></span>
                <button class="btn btn-sm btn-success right" data-toggle="modal" data-target="#addModal" <?php echo e($created_counts >= $login_limit ? 'disabled' : ''); ?>>Add New User</button>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="<?php echo e(url('user',$user->id)); ?>" target="_blank"  class="btn btn-sm btn-warning"><i class="fa fa-eye"></i></a>
                      ...
                      data-email="<?php echo e($user->email); ?>" data-phone="<?php echo e($user->phone); ?>" data-gender="<?php echo e($user->gender); ?>" data-city_id="<?php echo e($user->city_id); ?>" data-address="<?php echo e($user->address); ?>"><i class="fa fa-edit"></i></button>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\myflatinfo-ba\resources\views/admin/user/index.blade.php ENDPATH**/ ?>