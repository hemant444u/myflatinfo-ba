              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php $i = 0; ?>
                  <?php $__empty_1 = true; $__currentLoopData = $building->maintenances; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $maintenance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <?php $i++; ?>
                  <tr>
                    <td><?php echo e($i); ?></td>
                    <td><?php echo e($maintenance->from_date); ?></td>
                    <td><?php echo e($maintenance->to_date); ?></td>
                    <td><?php echo e($maintenance->amount); ?></td>
                    <td><?php echo e($maintenance->due_date); ?></td>
                    <td><?php echo e($maintenance->late_fine_type); ?></td>
                    <td><?php echo e($maintenance->late_fine_value); ?></td>
                    <td><?php echo e($maintenance->status); ?></td>
                    <td>
                      <!--<a href="<?php echo e(route('maintenance.show',$maintenance->id)); ?>" target="_blank"  class="btn btn-sm btn-warning"><i class="fa fa-eye"></i></a>-->
                      <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addModal" data-id="<?php echo e($maintenance->id); ?>" data-from_date="<?php echo e($maintenance->from_date); ?>"
                      data-to_date="<?php echo e($maintenance->to_date); ?>" data-building_id="<?php echo e($maintenance->building_id); ?>" data-amount="<?php echo e($maintenance->amount); ?>" data-status="<?php echo e($maintenance->status); ?>" 
                      data-due_date="<?php echo e($maintenance->due_date); ?>" data-late_fine_type="<?php echo e($maintenance->late_fine_type); ?>" data-late_fine_value="<?php echo e($maintenance->late_fine_value); ?>"><i class="fa fa-edit"></i></button>
                      <!--<?php if($maintenance->deleted_at): ?>-->
                      <!--<button class="btn btn-sm btn-success" data-toggle="modal" data-target="#deleteModal" data-id="<?php echo e($maintenance->id); ?>" data-action="restore"><i class="fa fa-undo"></i></button>-->
                      <!--<?php else: ?>-->
                      <!--<button class="btn btn-sm btn-danger" data-toggle="modal" data-target="#deleteModal" data-id="<?php echo e($maintenance->id); ?>" data-action="delete"><i class="fa fa-trash"></i></button>-->
                      <!--<?php endif; ?>-->
                    </td>
...
<div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <form action="<?php echo e(route('maintenance.store')); ?>" method="post" class="add-form" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
...
<script>
  $(document).ready(function(){
    ...
    $(document).on('click','#delete-button',function(){
      var url = "<?php echo e(route('maintenance.destroy','')); ?>";
      $.ajax({
        url : url + '/' + id,
        type: "DELETE",
    ...
    $('.status').bootstrapSwitch('state');
        $('.status').on('switchChange.bootstrapSwitch',function () {
            var id = $(this).data('id');
            $.ajax({
                url : "<?php echo e(url('update-maintenance-status')); ?>",
                type: "post",
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\myflatinfo-ba\resources\views/admin/maintenance/index.blade.php ENDPATH**/ ?>