              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo e($building->user->name); ?></td>
                    <td><?php echo e($building->builder->name); ?></td>
                    <td><?php echo e($building->builder->phone); ?></td>
                    
                    <td><?php echo e($building->flats->count()); ?></td>
                    <td><?php echo e($building->users->count()); ?></td>
                    ...
                    <!--  data-city_id="<?php echo e($building->city_id); ?>" data-zip_code="<?php echo e($building->zip_code); ?>" data-address="<?php echo e($building->address); ?>" data-user_id="<?php echo e($building->user_id); ?>" -->
                    <!--  data-image="<?php echo e($building->image); ?>" data-owner_name="<?php echo e($building->owner_name); ?>" data-owner_contact_no="<?php echo e($building->owner_contact_no); ?>"><i class="fa fa-edit"></i></button>-->
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\myflatinfo-ba\resources\views/admin/building/index.blade.php ENDPATH**/ ?>