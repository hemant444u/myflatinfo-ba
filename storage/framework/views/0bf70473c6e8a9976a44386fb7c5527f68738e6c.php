              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <b>Email</b> <a class="float-right"><?php echo e($customer->email); ?></a>
                  </li>
                  <li class="list-group-item">
                  ...
                  <li class="list-group-item">
                    <b>Wallet</b> <a class="float-right"><?php echo e($customer->wallet); ?></a>
                  </li>
                  <li class="list-group-item">
                    ...
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>Updated at</th>
                          <td><?php echo e($customer->updated_at); ?></th>
                        </tr>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\myflatinfo-ba\resources\views/admin/user/show.blade.php ENDPATH**/ ?>