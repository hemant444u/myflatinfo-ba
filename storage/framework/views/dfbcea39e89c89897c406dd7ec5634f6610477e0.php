...
<head>
  ...
  <link rel="shortcut icon" href="<?php echo e(asset('images/bussiness/'.$setting->favicon)); ?>">
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="#" class="nav-link"><?php echo e(Auth::User()->building->name); ?>

            (Departments:
            <?php $__empty_1 = true; $__currentLoopData = Auth::User()->departments(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $department): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <span class="badge badge-primary"></span><?php echo e($department->name); ?>,
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="<?php echo e(url('/')); ?>">
        <center>
            <img src="<?php echo e($setting->logo); ?>" alt="AdminLTE Logo" class="brand-image" style="width:100%">
        </center>
    </a>
    <?php $user = Auth::User(); ?>
    <!-- Sidebar -->
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url('/building-option')); ?>" class="nav-link <?php echo e(request()->is('building-option*') ? 'active' : ''); ?>">
          ...
          <li class="nav-item">
            <a href="<?php echo e(url('user')); ?>" class="nav-link <?php echo e(request()->is('user*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Users</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('guard.index')); ?>" class="nav-link <?php echo e(request()->is('guard*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Security Guards</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('block.index')); ?>" class="nav-link <?php echo e(request()->is('block*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Blocks</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('flat.index')); ?>" class="nav-link <?php echo e(request()->is('flat*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Flats</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('gate.index')); ?>" class="nav-link <?php echo e(request()->is('gate*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Gates</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('noticeboard.index')); ?>" class="nav-link <?php echo e(request()->is('noticeboard*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Notice Board</p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('issue.index')); ?>" class="nav-link <?php echo e(request()->is('issue*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Issue</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('facility.index')); ?>" class="nav-link <?php echo e(request()->is('facility*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Facility</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('visitor.index')); ?>" class="nav-link <?php echo e(request()->is('visitor*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Visitors</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('vehicles.index')); ?>" class="nav-link <?php echo e(request()->is('vehicles*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Vehicle</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(url('vehicle-inouts')); ?>" class="nav-link <?php echo e(request()->is('vehicle-inouts*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Vehicle Inouts</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('maintenance.index')); ?>" class="nav-link <?php echo e(request()->is('maintenance*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Maintenance</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('essential.index')); ?>" class="nav-link <?php echo e(request()->is('essential*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Essentials</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(url('society-fund/expenses')); ?>" class="nav-link <?php echo e(request()->is('society-fund*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Society Fund</p>
            </a>
          </li>
          <li class="nav-item">
            <a href="<?php echo e(route('role.index')); ?>" class="nav-link <?php echo e(request()->is('role*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
              <p>Roles</p>
            </a>
          </li>
          <?php $__empty_1 = true; $__currentLoopData = Auth::User()->building->roles; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $role): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
          <li class="nav-item">
            <a href="<?php echo e(url('department',$role->slug)); ?>" class="nav-link <?php echo e(request()->is('department/'.$role->slug.'*') ? 'active' : ''); ?>">
              <i class="nav-icon fas fa-duotone fa-user"></i>
...
$(document).ready(function(){
    ...
    $(function () {
        $(".table").DataTable({
          "responsive": true, "ordering": true, "lengthChange": false, "autoWidth": false,"bPaginate": true,"bInfo": false,"searching": true,"pageLength": parseInt("<?php echo e($setting->pagination); ?>"),
          order: [[0, 'asc']],
          buttons: [
            {
                extend: 'csvHtml5',
...
<?php /**PATH D:\myflatinfo-ba\resources\views/layouts/admin.blade.php ENDPATH**/ ?>