...
class CustomerController extends Controller
{
    ...
    public function maintenance_payments(Request $request)
    {
        ...
        //     ->orderBy('id', 'desc')
        //     ->get();
        $transactions = Transaction::where('user_id',$user->id)->where('model','Maintenance')->with(['user','maintenance_payments.maintenance','maintenance_payments.flat'])->orderBy('id','desc')->get();
