              ...
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  <li class="list-group-item">
                    <a href="<?php echo e(url('society-fund/expenses')); ?>" class="">Expenses</a>
                  </li>
                  <li class="list-group-item">
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php $i = 0; ?>
                  <?php $__empty_1 = true; $__currentLoopData = $building->expenses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $expense): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <?php $i++; ?>
                  <tr>
                    <td><?php echo e($i); ?></td>
                    <td><img src="<?php echo e($expense->image); ?>" style="width:40px;"></td>
                    <td><?php echo e($expense->reason); ?></td>
                    <td><?php echo e($expense->amount); ?></td>
                    <td><?php echo e($expense->date); ?></td>
                    <td><?php echo e($expense->created_at); ?></td>
                    <td>
                      <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addModal" data-id="<?php echo e($expense->id); ?>" data-reason="<?php echo e($expense->reason); ?>" data-amount="<?php echo e($expense->amount); ?>"   
                      data-image="<?php echo e($expense->image); ?>" data-date="<?php echo e($expense->date); ?>" data-building_id="<?php echo e($expense->building_id); ?>"><i class="fa fa-edit"></i></button>
                    </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\myflatinfo-ba\resources\views/admin/expenses/index.blade.php ENDPATH**/ ?>