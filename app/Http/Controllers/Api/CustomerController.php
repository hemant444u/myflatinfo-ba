...
class CustomerController extends Controller
{
    ...
    public function maintenance_payments(Request $request)
    {
        ...
        //     ->orderBy('id', 'desc')
        //     ->get();
        $transactions = Transaction::where('user_id',$user->id)->where('model','Maintenance')->with(['maintenance_payments','maintenance_payments.user','maintenance_payments.flat.block.building',])->orderBy('id', 'desc')->get();
