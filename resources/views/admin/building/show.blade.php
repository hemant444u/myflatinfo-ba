            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <b>Zip</b> <a class="float-right">{{$building->city->name}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Address</b><a class="float-right">{{$building->address}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Blocks</b> <a class="float-right">{{$building->blocks->count()}}</a>
                  </li>
                  <li class="list-group-item">
                    <b>Flats</b> <a class="float-right">{{$building->flats->count()}}</a>
                  </li>
                  <li class="list-group-item">
                    ...
                    <table class="table table-bordered table-striped">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>{{$flat->tanent->name}}</td>
                          <td>{{$flat->area}}</td>
                          <td>{{$flat->max_members}}</td>
                          <td>{{$flat->family_members}}</td>
                          <td>{{$flat->status}}</td>
                          <td>
