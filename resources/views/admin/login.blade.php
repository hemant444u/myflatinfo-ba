...
<head>
    ...
    <meta name="csrf-token" content="Ml63mUEFyaGvIM0h52l8aZ6cEGkZ61t2Jw0t9jhv" />
    <title>Admin Panel | {{$setting->bussiness_name}}</title>
                        ...
                        <form action="{{url('login')}}" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <input type="password" name="password" class="form-control password" minlength="8" maxlength="14" id="re_pass" required>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    <!--<div class="col-md-6">-->
                                    <!--    <a href="{{url('/')}}" class="text-danger" target="_blank">Go to User Panel</a>-->
                                    <!--</div>-->
                                    <div class="col-md-12">
                                        <a href="{{url('forget-password')}}" class="text-danger" style="float:right" target="_blank">Forgot Password ?</a>
                                    </div>
                                </div>
                                <p class="mt-5"><center><small>© Copyright <a href="https://allons-z.com/" target="_blank">My Flat Info</a></small></center></p>
                                <p>
                                    <center>
