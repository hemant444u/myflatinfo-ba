...
Route::middleware('admin')->group(function () {
    ...
    Route::get('/society-fund',[FundController::class, 'society_fund']);
    Route::post('/get-expenses',[FundController::class, 'get_expenses']);
    Route::post('/get-maintenance-funds',[FundController::class, 'get_maintenance_funds']);
    Route::post('/get-event-funds',[FundController::class, 'get_event_funds']);
    Route::post('/get-corpus-funds',[FundController::class, 'get_corpus_funds']);
    Route::post('/get-reciepts',[FundController::class, 'get_reciepts']);
