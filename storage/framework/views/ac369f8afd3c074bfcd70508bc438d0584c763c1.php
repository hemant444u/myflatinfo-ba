              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <?php $i = 0; ?>
                  <?php $__empty_1 = true; $__currentLoopData = $building->ads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ad): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                  <?php $i++; ?>
                  <tr>
                    <td><?php echo e($i); ?></td>
                    <td><?php echo e($ad->building->name); ?></td>
                    ...
                    <td>
                      ...
                      <button class="btn btn-sm btn-primary" data-toggle="modal" data-target="#addModal" data-id="<?php echo e($ad->id); ?>" data-building_id="<?php echo e($ad->building_id); ?>" 
                      data-name="<?php echo e($ad->name); ?>" data-link="<?php echo e($ad->link); ?>" data-status="<?php echo e($ad->status); ?>" data-image="<?php echo e($ad->image); ?>" ><i class="fa fa-edit"></i></button>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\myflatinfo-ba\resources\views/admin/ads/index.blade.php ENDPATH**/ ?>