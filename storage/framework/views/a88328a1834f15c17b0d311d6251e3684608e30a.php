...
<body style="background-color:black;">
    <div class="container">
        <div class="row mt-5">
            ...
            <?php $__empty_1 = true; $__currentLoopData = Auth::User()->buildings; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $building): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                <div class="col-lg-4 col-4">
                    <a href="<?php echo e(url('select-building',$building->id)); ?>">
                    <div class="card">
                        <div class="card-body">
                            <center>
                                <h2><?php echo e($building->name); ?></h2>
                                <hr>
                                <p>Address: <?php echo e($building->address); ?></p>
                                <hr>
                            </center>
                            <br>
...
</html><?php /**PATH D:\myflatinfo-ba\resources\views/admin/building_option.blade.php ENDPATH**/ ?>