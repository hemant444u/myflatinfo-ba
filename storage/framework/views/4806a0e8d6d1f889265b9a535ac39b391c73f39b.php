            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                <ul class="list-group list-group-unbordered mb-3">
                  ...
                  <li class="list-group-item">
                    <a href="<?php echo e(url('society-fund/maintenance')); ?>" class="">Maintenance Funds</a>
                  </li>
                  <li class="list-group-item">
                  ...
                  <li class="list-group-item">
                    <a href="<?php echo e(url('society-fund/reciepts')); ?>" class="" style="color:black">Reciepts</a>
                  </li>
                </ul>
              </div>
              <!-- /.card-body -->
              ...
              <div class="card-body">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                    ...
                    <td><?php echo e($maintenance->late_fine_type); ?> <?php echo e($maintenance->late_fine_value); ?></td>
                    <td><?php echo e(optional($maintenance->payments)->sum('paid_amount') ?? 0); ?></td>
                    <td><?php echo e(optional($maintenance->payments)->sum('dues_amount') ?? 0); ?></td>
                    <td><?php echo e(optional($maintenance->payments)->sum('late_fine') ?? 0); ?></td>
                    <td><?php echo e(optional($maintenance->payments)->sum('paid_amount') ?? 0 + optional($maintenance->payments)->sum('dues_amount') ?? 0 + optional($maintenance->payments)->sum('late_fine') ?? 0); ?></td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\myflatinfo-ba\resources\views/admin/fund/maintenance_funds.blade.php ENDPATH**/ ?>